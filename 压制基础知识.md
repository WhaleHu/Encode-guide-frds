...
![I_P_and_B_frames](I_P_and_B_frames.png)
...
![AviSynthInstall](AviSynthInstall.png)
...
<img src="VSRepoGUI.png" alt="image-20200209025555494" style="zoom:80%;" />
...
<img src="VS Editor.png" alt="image-20200210015648555" style="zoom: 88%;" />
...
![image-20200210024626480](Simple.png)
...
<img src="BDInfo.png" alt="BDInfo" style="zoom:95%;" />

### 2.分离提取(Demux)与音频转换

原盘的分离提取可以与音频格式转换一起通过**eac3to**进行，但**eac3to**软件对于SUP字幕分离时候出现问题，所以要对sup字幕正确性检查。

![image-20200215013629948](UsEac3To.png)
...
![image-20200220003824403](simplex264.png)
